...
extension colors on ColorScheme {
  static MaterialColor primary_app = const MaterialColor(
   ...
   static const Color primary = Color(0xff00874F);
  static const Color secondary = Color(0xffB6F237);
  ...
  static const Color grad1Color = Color(0xffB6F237);
  static const Color grad2Color = Color(0xffB6F237);
  static const Color lightWhite2 = Color(0xffEEF2F3);

  static const Color yellow = Color(0xfffdd901);

  static const Color red = Color(0xffB6F237);
